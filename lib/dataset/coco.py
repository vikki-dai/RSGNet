...
from dataset.CPJointsDataset import CPJointsDataset, CPRelationJointsDataset
...
class COCOCrowdDataset(CPJointsDataset):
    '''
    "keypoints": {
        0: "nose",
        1: "left_eye",
...
class COCOCPDataset(CPRelationJointsDataset):
    '''
    "keypoints": {
        0: "nose",
        1: "left_eye",
    ...
    def _xywh2cs(self, x, y, w, h):
        ...
        scale = np.array(
            ...
            dtype=np.float32)
        if center[0] != -1:
            scale = scale * 1.25  # this may cause more interferences
